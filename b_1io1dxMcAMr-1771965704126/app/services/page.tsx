...
export const metadata: Metadata = {
  ...
  description: "Professional focus areas in game direction and design leadership.",
}
      ...
      <main id="main">
        <section className="py-16 md:py-24">
          <div className="mx-auto max-w-5xl px-6">
            <h1 className="mb-6 font-serif text-3xl font-semibold md:text-5xl">Professional Focus</h1>
        ...
        <section className="pb-16">
          <div className="mx-auto max-w-5xl px-6">
            <h2 className="mb-8 font-serif text-2xl font-semibold md:text-3xl">Focus areas</h2>
            <div className="space-y-10">
              {SERVICES_CONTENT.offers.map((offer) => (
                <article key={offer.title} className="rounded-lg border border-border bg-card p-8 md:p-10">
                  ...
                  <h4 className="mb-4 text-sm font-semibold uppercase tracking-[0.2em]">Highlights</h4>
